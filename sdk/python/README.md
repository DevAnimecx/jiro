# Jiro Python SDK — Search API & Web Scraping
...
Official Python SDK for [Jiro Search API](https://searchjiro.vercel.app) — web scraping across 9 search engines and 12 social platforms.
