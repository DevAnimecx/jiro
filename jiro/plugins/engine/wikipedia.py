...
class WikipediaPlugin(BaseEnginePlugin):
    ...
    async def search(self, query: str, **kwargs) -> List[Dict[str, Any]]:
        ...
        params = {
            ...
            "list": "search",
            "srsearch": query,
            "srlimit": min(kwargs.get("max_results", 25), 50),
            "srprop": "snippet|title|timestamp|wordcount|size",
            "format": "json",
            "srinfo": "totalhits",
        }
    ...
    async def scrape(self, url: str) -> Dict[str, Any]:
        ...
        params = {
            "action": "query",
            "titles": title,
            "prop": "extracts|info|pageimages|categories|links|references",
            "exintro": True,
            "explaintext": True,
    ...
    def _parse_results(self, search_results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for item in search_results:
            results.append({
                ...
                "link": f"https://{self.lang}.wikipedia.org/wiki/{item.get('title', '').replace(' ', '_')}",
    ...
    def _parse_page(self, page: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "links": [l.get("title", "") for l in page.get("links", [])[:50]],
            "references": page.get("references", [])[:20],
